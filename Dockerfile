# based on https://github.com/zmartzone/mod_auth_openidc
FROM alpine
...
RUN openssl req -new -newkey rsa:4096 -days 3650 -nodes -x509 -subj "/C=BR/ST=SP/L=Sao Paulo/O=company/CN=localhost" \
